...
void GameModel::InitTools()
{
	...
	AllocTool(std::make_unique<DecorationTool>(view, DECO_ADD     , "ADD" , "Colour blending: Add."                         , 0x0000ff_rgb, "DEFAULT_DECOR_ADD" ));
	AllocTool(std::make_unique<DecorationTool>(view, DECO_SUBTRACT, "SUB" , "Colour blending: Subtract."                    , 0x0000ff_rgb, "DEFAULT_DECOR_SUB" ));
	AllocTool(std::make_unique<DecorationTool>(view, DECO_MULTIPLY, "MUL" , "Colour blending: Multiply."                    , 0x0000ff_rgb, "DEFAULT_DECOR_MUL" ));
	AllocTool(std::make_unique<DecorationTool>(view, DECO_DIVIDE  , "DIV" , "Colour blending: Divide."                      , 0x0000ff_rgb, "DEFAULT_DECOR_DIV" ));
	AllocTool(std::make_unique<DecorationTool>(view, DECO_SMUDGE  , "SMDG", "Smudge tool, blends surrounding deco together.", 0x0000ff_rgb, "DEFAULT_DECOR_SMDG"));
	AllocTool(std::make_unique<DecorationTool>(view, DECO_CLEAR   , "CLR" , "Erase any set decoration."                     , 0x0000ff_rgb, "DEFAULT_DECOR_CLR" ));
	AllocTool(std::make_unique<DecorationTool>(view, DECO_DRAW    , "SET" , "Draw decoration (No blending)."                , 0x0000ff_rgb, "DEFAULT_DECOR_SET" ));
