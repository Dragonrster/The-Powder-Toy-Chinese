	...
	callback(callback_)
{
	...
	ui::Button * cancelButton = new ui::Button(ui::Point(0, Size.Y-16), ui::Point((Size.X/2)+1, 16), ByteString("取消").FromUtf8());
	...
	ui::Button * okayButton = new ui::Button(ui::Point(Size.X/2, Size.Y-16), ui::Point(Size.X/2, 16),  ByteString("確定").FromUtf8());
